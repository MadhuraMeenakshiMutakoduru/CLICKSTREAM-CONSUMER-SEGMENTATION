...
public class Customer {
    ...
    // Constructor
    public Customer(String shoppingId, String customerName, int age, String gender, String incomeLevel, 
                    String purchaseFrequency, String loyaltyLevel, String region, String lifestyle, 
                    String productPreference, int pagesVisited, int timeOnSite, 
                    int productsClicked, String categoriesExplored, String exitPage, 
                    int purchaseIntent) {
    ...
    // Getters and Setters
    // (Include getters for all attributes used in segmentation)
}
