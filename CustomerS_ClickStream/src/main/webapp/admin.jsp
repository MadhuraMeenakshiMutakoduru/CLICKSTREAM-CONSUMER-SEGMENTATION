	...
	<div class="container-fluid py-4 px-3">
		...
		<div class="container">
			<div class="row px-3">
				...
				<div class="col-md-4 offset-md-2">
					<a href="segmentationResult.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="Images/users.png" style="max-width: 80px;"
									class="img-fluid">
								<h4 class="card-title mt-3">Upload DataSet</h4>
							</div>
						</div>
					</a>
				</div>
				...
				<div class="col-md-4 offset-md-2">
					<a href="cust_seg_byAdmin.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="Images/users.png" style="max-width: 80px;"
									class="img-fluid">
								<h4 class="card-title mt-3">See All ClickStream Data</h4>
							</div>
						</div>
					</a>
				</div>
